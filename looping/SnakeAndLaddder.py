...
while True:
    ...
    user_one_current_location = find_user_current_location(user_choice, user_one_current_location)
    ...
    user_two_current_location = find_user_current_location(system_choice, user_two_current_location)
